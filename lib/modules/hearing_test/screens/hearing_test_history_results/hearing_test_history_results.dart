                            ...
                            itemBuilder: (context, index) {
                              ...
                              return FutureBuilder<String>(
                                ...
                                builder: (context, fileSnapshot) {
                                  ...
                                  final leftEar = json['leftEarResults'] as List<dynamic>;
                                  final rightEar = json['rightEarResults'] as List<dynamic>;
                                  leftEarData.add(leftEar.map((e) => e == null ? null : (e as num).toDouble()).toList());
                                  rightEarData.add(rightEar.map((e) => e == null ? null : (e as num).toDouble()).toList());
                                  return Column(
                                    children: [
                                      ListTile(
                                        title: Text(dateLabel),
